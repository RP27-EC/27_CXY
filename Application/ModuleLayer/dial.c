...
static void Shoot_send_dial_output(shoot_t *shoot);                                                            // 拨盘输出下发电机
...
static void Shoot_Extern_Update(shoot_t *shoot)
{
    ...
    // ======================== 发射命令标志位 ========================
    shoot->extern_input.shoot_flag.Enable_Shoot_Flag =car.shoot_flag.Enable_Shoot_Flag;
    shoot->extern_input.shoot_flag.Shoot_Ctrl_Flag = car.shoot_flag.Shoot_Ctrl_Flag;
    shoot->extern_input.shoot_flag.Shoot_Mode = car.shoot_flag.Shoot_Mode;
...
static void Shoot_First_Bullet_Time_Update(shoot_t *shoot)
{
    ...
    if (car.shoot_flag.Shoot_Ctrl_Flag == 1 && last_shoot_flag == 0)
    {
    ...
    last_shoot_flag = car.shoot_flag.Shoot_Ctrl_Flag;
 ...
 * @brief  瓴控拨盘can输出
 */
static void Shoot_send_dial_output(shoot_t *shoot)
{
